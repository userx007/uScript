...
public:
    ...
    static std::string to_string(Status code)
    {
        ...
        case Status::PORT_ACCESS:
            return "PORT_ACCESS";
        case Status::READ_ERROR:
            return "READ_ERROR";
        case Status::WRITE_ERROR:
            return "WRITE_ERROR";
        case Status::READ_TIMEOUT:
            return "READ_TIMEOUT";
        case Status::WRITE_TIMEOUT:
            return "WRITE_TIMEOUT";
        case Status::OUT_OF_MEMORY:
            return "OUT_OF_MEMORY";
        case Status::BUFFER_OVERFLOW:
            return "BUFFER_OVERFLOW";
        case Status::FLUSH_FAILED:
            return "FLUSH_FAILED";
        case Status::RETVAL_NOT_SET:
            return "RETVAL_NOT_SET";
        case Status::OPERATION_FAILED:
