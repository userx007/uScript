...
bool FT245Plugin::m_FT245_INFO(const std::string& args, std::stop_token st ) const
{
    ...
    LOG_PRINT(LOG_EMPTY, LOG_STRING("Args   : [x=DEVICE_INDEX] [v=DEFAULT_VARIANT] [fm=DEFAULT_FIFO_MODE] [r=READ_TIMEOUT] [sd=SCRIPT_DELAY]"));
    LOG_PRINT(LOG_EMPTY, LOG_STRING("Usage  : FT245.CONFIG fm=Sync r=2000"));
    LOG_SEP();
