#ifndef FT245_GENERIC_HPP
#define FT245_GENERIC_HPP
...
#define FT_BULK_MAX_BYTES        ((size_t)(65536U))  // FT245 FIFO max per transfer
                               ...
                               const std::string& args)
{
    ...
    if (!pSpeedMap) {
        // No preset map for this module
        LOG_PRINT(LOG_ERROR, LOG_HDR; LOG_STRING(strModule);
                  LOG_STRING(": no speed presets available for this module"));
        return false;
    }
