...
/*--------------------------------------------------------------------------------------------------------*/
/**
  * \brief Parse a key=value token stream and dispatch each token to the matching FT4232 setter.
  *
  * Recognised keys:
  *   x    –  u8DeviceIndex        (calls setDeviceIndex)
  *   spc  –  eSpiChannel          (calls setSpiChannel)
  *   i2cc –  eI2cChannel          (calls setI2cChannel)
  *   gc   –  eGpioChannel         (calls setGpioChannel)
  *   uc   –  eUartChannel         (calls setUartChannel)
  *   spf  –  u32SpiClockHz        (calls setSpiClockHz)
  *   i2f  –  u32I2cClockHz        (calls setI2cClockHz)
  *   a    –  u8I2cAddress         (calls setI2cAddress)
  *   baud –  u32UartBaudRate      (calls setUartBaudRate)
...
bool parseAndCallHandlers(const T *pOwner, const std::string& input)
{
    ...
    static constexpr Entry table[] = {
        {"x", &T::setDeviceIndex},
        {"spc", &T::setSpiChannel},
        {"i2cc", &T::setI2cChannel},
        {"gc", &T::setGpioChannel},
        {"uc", &T::setUartChannel},
        {"spf", &T::setSpiClockHz},
        {"i2f", &T::setI2cClockHz},
        {"a", &T::setI2cAddress},
        {"baud", &T::setUartBaudRate},
        {"r", &T::setReadTimeout},
        {"sd", &T::setScriptDelay},
    };
