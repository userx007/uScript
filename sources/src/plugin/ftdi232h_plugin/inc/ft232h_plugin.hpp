...
#define FT232H_PLUGIN_NAME     "FT232H"

///////////////////////////////////////////////////////////////////
//               TOP-LEVEL PLUGIN COMMANDS                       //
///////////////////////////////////////////////////////////////////

// FT232H_GET_BLOCKING: picks blocking flag when provided, defaults to false.
#ifndef FT232H_GET_BLOCKING
#define FT232H_GET_BLOCKING(name, blocking, ...) blocking
#endif
...
public:
    ...
    FT232HPlugin()
        ...
        , m_strInstanceName(FT232H_PLUGIN_NAME)
...
private:
    ...
    // "FT232H" or "FT232H:1" -- see PluginDataSet::strInstanceName).
    // Falls back to FT232H_PLUGIN_NAME when unset.
