...
/*--------------------------------------------------------------------------------------------------------*/
/**
  * \brief Parse a key=value token stream and dispatch each token to the matching CP2112 setter.
  *
  * Recognised keys:
  *   x    –  u8DeviceIndex        (calls setDeviceIndex)
  *   c    –  u32I2cClockHz        (calls setI2cClockHz)
