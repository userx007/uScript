...
/*--------------------------------------------------------------------------------------------------------*/
/**
  * \brief Parse a key:value token stream and dispatch each token to the matching UDP setter.
  *
  * Recognised keys:
  *   h  –  default peer host  (calls setUdpHost)
  *   p  –  default peer port  (calls setUdpPort)
  *   c  –  connect timeout    (calls setConnectTimeout)
  *   r  –  read timeout       (calls setReadTimeout)
  *   w  –  write timeout      (calls setWriteTimeout)
  *   s  –  read buf size      (calls setUdpReadBufferSize)
  *
