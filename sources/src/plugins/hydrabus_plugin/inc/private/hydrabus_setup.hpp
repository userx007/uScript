 ...
 */
/*--------------------------------------------------------------------------------------------------------*/
bool HydrabusPlugin::m_LocalSetParams(const PluginDataSet *psSetParams)
{
    m_strInstanceName = psSetParams->strInstanceName.empty() ? HYDRABUS_PLUGIN_NAME : psSetParams->strInstanceName;
...
/*--------------------------------------------------------------------------------------------------------*/
template <typename T>
bool generic_hydrabus_set_params(const T *pOwner, const std::string &strArgs)
{
    // clang-format off
