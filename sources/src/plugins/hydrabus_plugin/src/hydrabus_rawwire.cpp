...
bool HydrabusPlugin::m_handle_rawwire_cfg(const std::string &strArgs, std::stop_token /*st*/) const
{
    auto *p = m_rawwire();
...
bool HydrabusPlugin::m_handle_rawwire_speed(const std::string &strArgs, std::stop_token /*st*/) const
{
...
bool HydrabusPlugin::m_handle_rawwire_sda(const std::string &strArgs, std::stop_token /*st*/) const
{
    if (strArgs == "help") {
...
bool HydrabusPlugin::m_handle_rawwire_clk(const std::string &strArgs, std::stop_token st) const
{
    if (strArgs == "help") {
...
bool HydrabusPlugin::m_handle_rawwire_bit(const std::string &strArgs, std::stop_token st) const
{
    if (strArgs == "help") {
        LOG_PRINT(LOG_EMPTY,
...
bool HydrabusPlugin::m_handle_rawwire_ticks(const std::string &strArgs, std::stop_token st) const
{
    if (strArgs == "help") {
    ...
    size_t n = 0;
    if (!numeric::str2sizet(strArgs, n) || n == 0 || n > 16) {
...
bool HydrabusPlugin::m_handle_rawwire_write(const std::string &strArgs, std::stop_token st) const
{
    if (strArgs == "help") {
...
bool HydrabusPlugin::m_handle_rawwire_read(const std::string &strArgs, std::stop_token st) const
{
    if (strArgs == "help") {
...
bool HydrabusPlugin::m_handle_rawwire_aux(const std::string &strArgs, std::stop_token /*st*/) const
{
    return m_handle_aux_common(strArgs, m_rawwire());
}
