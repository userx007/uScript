...
bool KSPIPlugin::m_KSPI_INFO(const std::string &strArgs, std::stop_token st) const
{
...
bool KSPIPlugin::m_KSPI_CONFIG(const std::string &strArgs, std::stop_token st) const
{
    return generic_spi_set_params<KSPIPlugin>(this, strArgs);
}
...
bool KSPIPlugin::m_KSPI_CMD(const std::string &strArgs, std::stop_token st) const
{
    (void)st;
...
bool KSPIPlugin::m_KSPI_SCRIPT(const std::string &strArgs, std::stop_token st) const
{
    (void)st;
...
bool KSPIPlugin::m_KSPI_CYCLIC(const std::string &strArgs, std::stop_token st) const
{
...
bool KSPIPlugin::m_Receive(std::span<uint8_t> dataSpan, size_t &szSize, CommCommandReadType eReadType, std::shared_ptr<const ICommDriver> shpDriver) const
{
    bool bRetVal = false;
