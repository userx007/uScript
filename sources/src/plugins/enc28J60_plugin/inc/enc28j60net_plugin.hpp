...
public:
    Enc28J60NetPlugin()
        : m_strVersion(ENC28J60NET_PLUGIN_VERSION)
...
#undef ENC28J60NET_PLUGIN_CMD_RECORD
    ...
    const PluginCommandsMap<Enc28J60NetPlugin> *getMap(void) const
    {
        return &m_mapCmds;
    }
    ...
    void setServerIp(const std::string &strServerIp) const
    {
