#ifndef FT4232_SPI_CONFIG_HPP
#define FT4232_SPI_CONFIG_HPP
...
///////////////////////////////////////////////////////////////////
//              Common SPI clock presets (convenience names)     //
//  These feed generic_module_set_speed → setModuleSpeed(SPI,N)  //
//  where N is the Hz value directly (no enum translation).      //
///////////////////////////////////////////////////////////////////
