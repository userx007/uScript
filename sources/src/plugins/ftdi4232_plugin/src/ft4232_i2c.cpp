...
bool FT4232Plugin::m_handle_i2c_open(const std::string &strArgs, std::stop_token /*st*/) const
{
    if (strArgs == "help") {
        LOG_PRINT(LOG_EMPTY,
...
bool FT4232Plugin::m_handle_i2c_cfg(const std::string &strArgs, std::stop_token /*st*/) const
{
...
bool FT4232Plugin::m_handle_i2c_write(const std::string &strArgs, std::stop_token st) const
{
    if (strArgs == "help") {
        LOG_PRINT(LOG_EMPTY,
...
bool FT4232Plugin::m_handle_i2c_read(const std::string &strArgs, std::stop_token st) const
{
    if (strArgs == "help") {
        LOG_PRINT(LOG_EMPTY,
...
bool FT4232Plugin::m_i2c_wrrd_cb(std::span<const uint8_t> req, size_t rdlen, std::stop_token st) const
{
    ...
    // Write phase (if any)
    if (!req.empty()) {
        auto wr = p->tout_write(p->FT4232_WRITE_DEFAULT_TIMEOUT, req, std::string_view{}, st);
...
bool FT4232Plugin::m_handle_i2c_wrrd(const std::string &strArgs, std::stop_token st) const
{
    return generic_write_read_data<FT4232Plugin>(
        this, strArgs, &FT4232Plugin::m_i2c_wrrd_cb, st);
}

bool FT4232Plugin::m_handle_i2c_wrrdf(const std::string &strArgs, std::stop_token st) const
{
    return generic_write_read_file<FT4232Plugin>(
        this, strArgs, &FT4232Plugin::m_i2c_wrrd_cb,
...
bool FT4232Plugin::m_handle_i2c_scan(const std::string &strArgs, std::stop_token /*st*/) const
{
    if (strArgs == "help") {
        LOG_PRINT(LOG_EMPTY,
...
bool FT4232Plugin::m_handle_i2c_script(const std::string &strArgs, std::stop_token st) const
{
    if (strArgs == "help") {
