...
bool FT4232Plugin::m_handle_gpio_help(const std::string &, std::stop_token /*st*/) const
{
...
bool FT4232Plugin::m_handle_gpio_close(const std::string &, std::stop_token /*st*/) const
{
    if (m_pGPIO) {
        m_pGPIO->close();
        m_pGPIO.reset();
