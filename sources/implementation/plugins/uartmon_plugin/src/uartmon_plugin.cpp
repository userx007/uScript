...
/**
  ...
  *       UARTMON.DUMMY arg1 arg2 <br>
  *       will perform your dummy action with two argument
  *       UARTMON.DUMMY arg1 arg2 arg3 <br>
...
bool UartmonPlugin::m_Uartmon_DUMMY1( const std::string &args ) const
{
    bool bRetVal = false;
...
bool UartmonPlugin::m_Uartmon_DUMMY2( const std::string &args ) const
{
    bool bRetVal = false;
...
bool UartmonPlugin::m_Uartmon_DUMMY3( const std::string &args ) const
{
    bool bRetVal = false;
